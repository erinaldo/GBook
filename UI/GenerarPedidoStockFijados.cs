...
namespace UI
{
    public partial class GenerarPedidoStockFijados : Form, IObserver
    {
        ...
        public GenerarPedidoStockFijados(IProducto productoService, ILibro libroService, ICompra compraService, ITraductor traductorService)
        {
            InitializeComponent();
        ...
        {
            List<LibroDTO> productos = LibroDTO.FillListDTO(_libroService.GenerarAlertaPedidoStock());
